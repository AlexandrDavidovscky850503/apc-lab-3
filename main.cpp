...
//NEW INTERRUPTIONS
void interrupt  newint60(...) { print(); oldint8(); }                     // set function for service interrupt	int8
void interrupt  newint61(...) { changeColor(); print(); oldint9(); }	  // set function for service interrupt	int9
void interrupt  newint62(...) { changeColor(); print(); oldint10(); }	  // set function for service interrupt	int10
void interrupt  newint63(...) { changeColor(); print(); oldint11(); }	  // set function for service interrupt	int11
void interrupt  newint64(...) { changeColor(); print(); oldint12(); }	  // set function for service interrupt	int12
void interrupt  newint65(...) { changeColor(); print(); oldint13(); }	  // set function for service interrupt	int13
void interrupt  newint66(...) { changeColor(); print(); oldint14(); }	  // set function for service interrupt	int14
void interrupt  newint67(...) { changeColor(); print(); oldint15(); }	  // set function for service interrupt	int15

void interrupt  newint08(...) { changeColor(); print(); oldint70(); }	  // set function for service interrupt	int70
void interrupt  newint09(...) { changeColor(); print(); oldint71(); }	  // set function for service interrupt	int71
void interrupt  newint0A(...) { changeColor(); print(); oldint72(); }	  // set function for service interrupt	int72
void interrupt  newint0B(...) { changeColor(); print(); oldint73(); }	  // set function for service interrupt	int73
void interrupt  newint0C(...) { changeColor(); print(); oldint74(); }	  // set function for service interrupt	int74
void interrupt  newint0D(...) { changeColor(); print(); oldint75(); }	  // set function for service interrupt	int75
void interrupt  newint0E(...) { changeColor(); print(); oldint76(); }	  // set function for service interrupt	int76
void interrupt  newint0F(...) { changeColor(); print(); oldint77(); }	  // set function for service interrupt	int77
...
void initialize()
{
	...
	setvect(0x60, newint60);		// set new handlers for IRQ 8
	setvect(0x61, newint61);		// set new handlers for IRQ 9
	setvect(0x62, newint62);		// set new handlers for IRQ 10
	setvect(0x63, newint63);		// set new handlers for IRQ 11
	setvect(0x64, newint64);		// set new handlers for IRQ 12
	setvect(0x65, newint65);		// set new handlers for IRQ 13
	setvect(0x66, newint66);		// set new handlers for IRQ 14
	setvect(0x67, newint67);		// set new handlers for IRQ 15
	...
	outp(0x21, 0x60);				// ICW2 - base vector for MASTER
